...
def play_round(computer, human):
    ...
    while game_in_progress:
        ...
        print(
            ...
            "Hedio has {1} health remaining."
            .format(human.health, computer.health))
        print()

        if (current_player == human):
            print("Available attacks:")
            print("1) fire ball - Causes moderate damage.")
            print("2) crousive - high or low damage, "
                  "depending on your luck!")
            print("3) gloden apple - Restores a moderate amount of health.")
            move = get_selection()
        else:
        ...
        if (computer.health == 0):
            print("Congratulations, you beat Hedio!")
            human.wins += 1
            game_in_progress = False
...
def start_game():
    ...
    while (keep_playing is True):
        ...
        print("Hedio - {0}".format(computer.wins))
